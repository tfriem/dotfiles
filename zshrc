...
plugins=(vi-mode git virtualenvwrapper virtualenv zsh-nvm tmux colored-man-page cp copyfile copydir dircycle dirpersist rsync tig zsh-syntax-highlighting history-substring-search)
