...
plugins=(vi-mode git virtualenvwrapper virtualenv zsh-nvm tmux colored-man-pages cp copyfile copydir dircycle dirpersist rsync tig history-substring-search)
